...
from farkle.game.scoring import score_roll_cached, generate_sequences, score_lister, _select_candidate, _must_bank
...
def must_bank(score_after, dice_left_after):
    return _must_bank(score_after, dice_left_after,
