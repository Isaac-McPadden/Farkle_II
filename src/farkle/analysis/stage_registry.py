...
_REGISTRY: tuple[StageDefinition, ...] = (
    ...
    StageDefinition(
        ...
        cache_scope=(
            ...
            "sim.n_players_list",
            "k_aggregation",
            "analysis.game_stats_margin_thresholds",
    ...
    StageDefinition(
        ...
        cache_scope=(
            ...
            "head2head.sensitivity_deltas",
            "head2head.seat1_advantage_scenarios",
            "head2head.min_candidate_completion_rate",
            "head2head.max_attempt_multiplier",
            "head2head.allow_single_root",
        ),
        cache_key_version=5,
    ),
    StageDefinition(
