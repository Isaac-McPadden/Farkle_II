...
Located under ``farkle.orchestration``, this module exposes small convenience
functions for running analytics passes directly on an experiment directory.
Each pass creates a ``.done.json`` stamp next to its primary output and skips
...
def main(argv: Sequence[str] | None = None) -> int:
    """Thin wrapper importing :func:`farkle.analysis.pipeline.main` lazily."""
